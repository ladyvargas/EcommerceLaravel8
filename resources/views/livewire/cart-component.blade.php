                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="quantity">
                            <div class="quantity-input">
                                ...
                                <a class="btn btn-increase" href="#" wire:click.prevent="store({{ $item->id }}, '{{ $item->model->name }}', {{ $item->model->regular_price }})"></a>
                                <a class="btn btn-reduce" href="#" wire:click.prevent="remove({{ $item->id }}, '{{ $item->model->name }}', {{ $item->model->regular_price }})"></a>
                            </div>
                        </div>
                        ...
                        <div class="delete">
                            <a href="#" class="btn btn-delete" title="Eliminar de su carrito" wire:click.prevent="destroy({{ $item->rowId }})">
